								...
								<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
									...
									<div class="row">
										...
										?>
												...
												<?php get_template_part( 'template-parts/content', 'archive-solutions' );//template-part - folder where are all the content files. get-template-part function will search a folder template-parts and files with start content- .
														//get_post_format() - retrieve the_post_format of the current post that is in the post loop. ?>
